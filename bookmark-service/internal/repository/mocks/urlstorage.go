...
// StoreURL provides a mock function with given fields: ctx, code, url, expSecond
func (_m *URLStorage) StoreURL(ctx context.Context, code string, url string, expSecond int64) error {
	ret := _m.Called(ctx, code, url, expSecond)
